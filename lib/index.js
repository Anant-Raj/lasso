...
function setCDNUrlArrayInLasso(CDNUrlArray){
    configDefaults.CDNUrlArray =  CDNUrlArray;
}

function overrideURLPrefix(url){
    configDefaults.urlPrefix = url + configDefaults.urlPrefix;
}
...
function configure(config, baseDir, filename, defaultConfigOverride) {
...
exports.overrideURLPrefix = overrideURLPrefix;
exports.setCDNUrlArrayInLasso = setCDNUrlArrayInLasso;
